...
// Design-side SSOT bridge: high-level unlock summary.
global.SFD_STAGE_UNLOCK_SUMMARY = Object.freeze({
  sfd_stage_0_welcome: 'Base guidance active, weather locked',
  sfd_stage_1_beginning: 'Early bio progression active, weather locked',
  sfd_stage_2_stone: 'Stone chain active, heat preparation active',
  sfd_stage_3_heat: 'Weather unlock policy eligible',
  sfd_stage_4_machines: '',
  sfd_stage_5_automation: 'Comet unlock policy eligible',
  sfd_stage_6_endgame: ''
});
