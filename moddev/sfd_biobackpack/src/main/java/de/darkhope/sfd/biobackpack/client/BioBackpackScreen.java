...
public class BioBackpackScreen extends AbstractContainerScreen<BioBackpackMenu> {
  private static final ResourceLocation TEXTURE = new ResourceLocation("minecraft", "textures/gui/container/dispenser.png");

  public BioBackpackScreen(BioBackpackMenu menu, Inventory playerInventory, Component title) {
